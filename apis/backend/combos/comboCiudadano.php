<?php
$dir_fc = "../";
include_once $dir_fc.'data/api.combos.class.php';
...
$app->post('/combos/comboCiudadano',function(Request $request, Response $response){

	$id_ciudadano = $request->getParam('id_ciudadano
    ');
	...
	$reg  	 = $cAccion->getComboCiudadanos();
